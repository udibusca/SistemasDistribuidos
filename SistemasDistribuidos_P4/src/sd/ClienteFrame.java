...
public class ClienteFrame extends javax.swing.JFrame {
    ...
    private void refreshOnlines(Chat message) {
        ...
        String[] arrayNomes = (String[]) names.toArray(new String[names.size()]);
        
        this.listOnlines.setListData(array);
        this.listOnlines.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        this.listOnlines.setLayoutOrientation(JList.VERTICAL);
        
        this.listaUserConectados.setListData(arrayNomes);
        this.listaUserConectados.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        this.listaUserConectados.setLayoutOrientation(JList.VERTICAL);
    }
    ...
    private void initComponents() {
        ...
        listaUserConectados = new JList();
        listaUserConectados.setModel(new AbstractListModel() {
        ...
        scrollPaneUserOnline = new JScrollPane();
        scrollPaneUserOnline.setToolTipText("");
        ...
        scrollPaneUserOnline.setViewportView(listaUserConectados);
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        				.addComponent(jPanelUserOnline, GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE)
        		...
        		.addGroup(layout.createSequentialGroup()
        			.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(jPanelUserOnline, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        				.addComponent(jPanel2, GroupLayout.PREFERRED_SIZE, 405, GroupLayout.PREFERRED_SIZE))
        			.addContainerGap())
        );
        
        jPanelUserOnline.add(scrollPaneUserOnline);
  ...
  //inicio variaveis de Painel
    ...
    //inicio variaveis de Scrolls
    private javax.swing.JScrollPane scrollPaneUserOnline;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JScrollPane jScrollPane2;
    private javax.swing.JScrollPane jScrollPane3;
    
    // Listas
    private javax.swing.JList listaUserConectados;
